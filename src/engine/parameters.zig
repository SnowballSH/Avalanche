pub var LMRWeight: f64 = 0.462;
pub var LMRBias: f64 = 0.877;

pub var RFPDepth: i32 = 9;
pub var RFPMultiplier: i32 = 65;
pub var RFPImprovingDeduction: i32 = 81;
...
pub var RazoringMargin: i32 = 225;
...
pub const TunableParams = [_]Tunable{
    Tunable{ .name = "LMRWeight", .value = "462", .min_value = "250", .max_value = "650", .c_end = "20", .r_end = "0.002", .id = 0 },
    Tunable{ .name = "LMRBias", .value = "877", .min_value = "300", .max_value = "1300", .c_end = "50", .r_end = "0.002", .id = 1 },
    ...
    Tunable{ .name = "RFPImprovingDeduction", .value = "81", .min_value = "20", .max_value = "120", .c_end = "5", .r_end = "0.002", .id = 4 },
    ...
    Tunable{ .name = "RazoringBase", .value = "69", .min_value = "20", .max_value = "140", .c_end = "6", .r_end = "0.002", .id = 9 },
    Tunable{ .name = "RazoringMargin", .value = "225", .min_value = "80", .max_value = "320", .c_end = "12", .r_end = "0.002", .id = 10 },
