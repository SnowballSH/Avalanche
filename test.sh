cutechess-cli -tournament gauntlet -concurrency 6 \
  -engine name="Old" dir=. cmd="./old_binaries/Avalanche" tc="20+0.5" timemargin=100 proto="uci" \
  -engine name="New" dir=. cmd="./zig-out/bin/Avalanche" tc="20+0.5" timemargin=100 proto="uci" \
  -recover \
